...
if(!isNaN('<?php echo $eq; ?>')){
  ...
  <div class="box box-solid">
    <div class="box-header with-border">
      <h3 class="box-title">vege列表</h3>
      <a href="<?php echo url('Admin/addflower'); ?>" class='btn btn-success btn-xs pull-right'>添加vege</a>
    </div>
    <div class="box-body">
