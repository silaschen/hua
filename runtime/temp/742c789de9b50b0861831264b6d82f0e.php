<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"/var/www/hua/application/index/view/index/shop.html";i:1522335727;s:51:"/var/www/hua/application/index/view/index/base.html";i:1522326403;}*/ ?>
<!DOCTYPE HTML>
<html lang="en-US">
    <head>
        <meta charset="utf-8">
												...
												<div class="row-pr">
													...
													<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
														...
														<div class="rating pull-right">
															<?php $__FOR_START_1360249706__=0;$__FOR_END_1360249706__=$vo['level'];for($k=$__FOR_START_1360249706__;$k < $__FOR_END_1360249706__;$k+=1){ ?>

																	<span class="ef icon_star"></span>


															<?php } $__FOR_START_1573699075__=0;$__FOR_END_1573699075__=5-$vo['level'];for($k=$__FOR_START_1573699075__;$k < $__FOR_END_1573699075__;$k+=1){ ?>
							...
							<div class="left-block-wrapper wow fadeInUp">
								...
								<div class="lb-content lb-content-accordion">
									<div id="accordion" class="accordion-l-box">
										...
										<div>
											<ul>
												<li class="active"><a href="<?php echo url('index/index/store',array('cate'=>1,'name'=>'君子兰')); ?>">jun</a></li>
												<li><a href="<?php echo url('index/index/store',array('cate'=>1,'name'=>'小天鹅')); ?>">Hedge Cutters</a></li>
										...
										<div>
											<ul>
												<li class="active"><a href="<?php echo url('index/index/store',array('type'=>2,'cate'=>1)); ?>">蔬菜瓜果</a></li>
												<li><a href="<?php echo url('index/index/store',array('type'=>2,'cate'=>2)); ?>">Hedge Cutters</a></li>
												<li><a href="#">Cultivators</a></li>
												<li><a href="#">Ride-On Movers</a></li>
												<li><a href="#">Water Pumps</a></li>
											</ul>
